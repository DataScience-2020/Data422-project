...
# This code is to deal with NLP analysis, by reading text data from twitter API
...
stop_list <-c(term, "https", "http", "co")
stop_words <- ""
...
# now we can remove stopwords in data column 'text' retrived by rtweet API
text.to.analyze <- ""
...
#text.to.analyze <- read_file("/Users/azurewood/UC/INFO634/exam/lecture_notes.txt")
